; =============================================================================
;   1x-04-module.asm
;   An atomic script that performs the modulo operation on two hardcoded
;   single-digit numbers and prints the result in the format "a % b = c".
; =============================================================================
...
_start:
    ...
    ; --- Step 3: Calculate the remainder (modulo) ---
    mov al, [num1]
    mov ah, 0           ; clear ah for 16-bit division
    mov bl, [num2]
    div bl              ; ax / bl, quotient in al, remainder in ah

    ; --- Step 4: Convert the remainder to ASCII ---
    add ah, '0'         ; convert remainder to ascii

    ; --- Step 5: Place the remainder into the message ---
    mov [msg + 8], ah   ; remainder
