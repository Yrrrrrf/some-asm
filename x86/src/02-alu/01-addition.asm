; =============================================================================
;   1x-01-addition.asm
;   An atomic script that adds two hardcoded single-digit numbers and
...
_start:
    ...
    ; --- Step 3: Calculate the sum and place it into the message ---
    mov al, [num1]      ; Load num1 into AL again.
    add al, [num2]      ; Add num2 to it. The sum is now in AL.
    add al, '0'         ; Convert the sum to ASCII.
    mov [msg + 8], al   ; Place the sum character at the 9th position.
